        ...
        <div className="container px-4 py-3">
          ...
          <div className="flex flex-col gap-3 md:hidden">
            ...
            <div className="flex items-center justify-center gap-2">
              <h1 className="text-lg font-bold">Estudio de Encarte</h1>
          ...
          <div className="hidden md:flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold">Estudio de Encarte</h1>
              <span className="text-xs text-muted-foreground bg-muted px-2 py-0.5 rounded">V.23.0</span>
            </div>
            <div className="flex items-center gap-4">
          ...
          {/* Network Status Row - shown on both mobile and desktop */}
...
export default EncuestadorEncarte;
